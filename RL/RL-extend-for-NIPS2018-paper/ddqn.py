...
class DoubleDQN:
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            c_names, n_l1, w_initializer, b_initializer = \
                ['eval_net_params', tf.GraphKeys.GLOBAL_VARIABLES], self.fc_node, \
    ...
    def choose_action(self, observation, choose_reverse=False):
        observation = observation[np.newaxis, :]
        actions_value = self.sess.run(self.q_eval, feed_dict={self.s: observation})
        if choose_reverse is True:
    ...
    def learn(self, samples=None, q_mod_eval=None, q_mod_target=None, q_mod_rate=None):
        ...
        # print(self.learn_step_counter, self.last_replace_target,self.replace_target_iter)
